...
<head>
        <title>Pulse Point Admin</title><meta charset="UTF-8" />
    ...
    <div id="loginbox">            
            <form id="loginform" class="form-vertical" method="POST" action="#">
                 ...
                 <h3><img src="../img/pulselogo.png" alt="Logo" width="200px" height="200px" /></h3>
                ...
                <div class="form-actions">
                    <span class="pull-left"><a href="#" class="flip-link btn btn-info" id="to-recover">Register Yourself !</a></span>
